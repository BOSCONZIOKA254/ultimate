...
public class ClientLogIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Client Log In Form");
        ...
        jButton1.setText("Click Here To Create An Account");
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 0, 300, 300));
    ...
    PreparedStatement ps;
        ...
        String query = "SELECT * FROM `eagleseye_707` WHERE `U_name` =? AND `Pass` =?";
        ...
        try {
            ...
            if(rs.next())
            {
                    ...
                    uh.setExtendedState(JFrame.NORMAL);
